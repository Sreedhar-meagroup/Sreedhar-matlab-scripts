% Aim: To analyze NetControl data in Experiments7 onwards, where 30 min
% spontaneous activity was recorded between each training-testing session
% pair. So the contiguous data chain would be
% (training-testing-spontaneous)\times N%
