...
RecChannel_pre = bursts_at_RecSite(pre_spont.Spikes,[0.2,0.2,3],recSite_in_hwpo);
...
RecChannel_post = bursts_at_RecSite(post_spont.Spikes,[0.2,0.2,3],recSite_in_hwpo);
% Single channel IBI plot
