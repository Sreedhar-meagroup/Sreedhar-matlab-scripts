...
%13/11/06 
%changed this file because from now on, I try to record with longer cutouts,
...
raw = fread(fid,[132 inf],'int16');     %fills an 132xinf matrix, where inf actually means until the end of file, i.e. the whole file
