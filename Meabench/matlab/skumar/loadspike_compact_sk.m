...
function y=loadspike_compact_sk(fn,range,freq)
% y=LOADSPIKE_COMPACT_SK(fn) loads spikes WITHOUT FIELDS CONTEXT, HEIGHT, WIDTH, 
% THRESH IN THE STRUCTURE. from given filename into structure y with members 
% (but not suitable for huge data files (cf. loadspike_noc2_sk.m)) 
% time    (1xN) (in samples) 
%   channel (1xN)

% y=LOADSPIKE_COMPACT_SK(fn,range,freq_khz) converts times to seconds and width to
...
% matlab/skumar/loadspike_compact_sk.m: modfied from meabench, an MEA recording and analysis tool
...
% 17/11/14: This is the script to use to load .spike files in a compact
% fashion with time stamp and channel fields alone.
